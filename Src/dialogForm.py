...
class Ui_Dialog_scrap(object):
    def setupUi(self, Dialog_scrap):
        ...
        #radioButton_mkdirs
        self.radioButton_mkdirs = QtWidgets.QRadioButton(self.groupBox_downType)
        self.radioButton_mkdirs.setGeometry(QtCore.QRect(30, 40, 191, 16))
        self.radioButton_mkdirs.setObjectName("radioButton_mkdirs")
        ...
        Dialog_scrap.setTabOrder(self.radioButton_justName, self.radioButton_mkdirs)
        Dialog_scrap.setTabOrder(self.radioButton_mkdirs, self.lineEdit_id)
    ...
    def retranslateUi(self, Dialog_scrap):
        ...
        self.radioButton_mkdirs.setText(_translate("Dialog_scrap", "학습자료/과제 디렉토리 생성"))
    ...
    @QtCore.pyqtSlot()
    def on_pushButton_selectDir_clicked (self):
